...
class IsaacusLoader(BaseLoader):
    ...
    """
    Isaacus document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import IsaacusLoader

            loader = IsaacusLoader(
                # required params = ...
                # other params = ...
            )
