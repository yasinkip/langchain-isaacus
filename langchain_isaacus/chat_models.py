...
class ChatIsaacus(BaseChatModel):
    ...
    """Isaacus chat model integration.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Isaacus API key. If not passed in will be read from env var ISAACUS_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatIsaacus.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatIsaacus.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatIsaacus supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatIsaacus supports async generation. Otherwise delete.
